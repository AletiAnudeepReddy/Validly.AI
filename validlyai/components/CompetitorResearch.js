...
const competitors = [
  {
    ...
    focus: 'Student Internships & Jobs',
    strengths: ['Large user base', 'Trusted by universities', 'Good UI/UX'],
    weaknesses: ['Not focused on local gigs', 'Limited personalization'],
  },
  {
    name: 'GigIndia',
    website: 'https://gigindia.in',
    focus: 'Gig Work for Youth',
    strengths: ['Corporate tie-ups', 'Performance tracking'],
    weaknesses: ['City-limited', 'High churn rate'],
  },
  {
    name: 'Fiverr',
    website: 'https://fiverr.com',
    focus: 'Global Freelancing',
    strengths: ['Global exposure', 'Diverse categories'],
    weaknesses: ['High competition', 'Freelancer saturation'],
  },
];

export default function CompetitorResearch() {
  useEffect(() => {
    // In future: call scraper/AI to get competitors
  }, []);
  ...
  {competitors.map((comp, idx) => (
    ...
    >
      ...
      <div className="grid grid-cols-4 gap-6 items-start">
        ...
        {/* Column 4 is empty since Visit is absolutely positioned */}
      </div>
    </div>
  ))}
</div>
